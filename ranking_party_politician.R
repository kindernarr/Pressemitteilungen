...
library(magrittr)
library(e1071)
setwd("D:/Users/namentlich/Desktop/运算结果/政客，不限制词频，3个党一组")
...

{
  ...
  subcorpus_politician <- docs_arguments$DOCUMENT %>% 
    str_split("@", n = 2, simplify = T)
  docs_arguments$SUBCORPUS <- subcorpus_politician[,1]
  docs_arguments$POLITICIAN <- subcorpus_politician[,2]
